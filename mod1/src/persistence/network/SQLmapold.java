 ...
 * @author wizard1993
 */
class SQLmapold<V> implements Map<Integer, V> {
    ...
    public SQLmapold(String table, Information information) {
        this.table = table;
        try {
    ...
    public V get(Object key) throws IllegalAccessError {
        try {
            ...
            Logger.getLogger(SQLmapold.class.getName()).log(Level.SEVERE, null, ex);
        }
        return null;
    }
